...
urlpatterns = [
    ...
    path(
        "disputes/<str:id>/evidence/",
        views.ProvideEvidence.as_view(),
    ...
    path(
        "payment-refund",
        views.PaymentIntentRefund.as_view(),
        name="payment-refund",
    ),
    path(
        "legacy-payment",
        views.LegacyElementPage.as_view(),
        name="legacy-payment",
    ),
    ...
    path(
        "manage-billing",
        views.ManageSubscriptions.as_view(),
        name="manage-sub",
    ),
    ...
    path(
        "old-subscription",
        views.OldSubscriptionView.as_view(),
    ...
    path(
        "connect-accounts",
        views.ConnectAccountsView.as_view(),
    ...
    path(
        "connect-reauth", views.ConnectReauth.as_view(), name="connect-reauth"
    ),
    path("oauth-connect", views.OauthConnect.as_view(), name="oauth"),
    path(
        "oauth-redirect", views.OauthRedirect.as_view(), name="oauth-redirect"
    ),
    path("ece", views.ExpressCheckout.as_view(), name="express-checkout"),
    # FBVs
